...
object TheSportDBApi {
    ...
    fun getLeagueTeamSearch(searchKey: String?): String {
        /*return Uri.parse(BuildConfig.BASE_URL).buildUpon()
            .appendPath("api")
            .appendPath("v1")
            .appendPath("json")
            ...
            .build()
            .toString()*/
        return "${BuildConfig.BASE_URL}api/v1/json/${BuildConfig.TSDB_API_KEY}/searchteams.php?t=${searchKey}"
    }

    fun getLeaguePlayerSearch(searchKey: String?): String {
        /*return Uri.parse(BuildConfig.BASE_URL).buildUpon()
            .appendPath("api")
            .appendPath("v1")
            .appendPath("json")
            ...
            .build()
            .toString()*/
        return "${BuildConfig.BASE_URL}api/v1/json/${BuildConfig.TSDB_API_KEY}/searchplayers.php?t=${searchKey}"
    }
}